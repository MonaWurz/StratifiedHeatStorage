...
%radius_1 = 1;
%radius_2 = 0.5742;                 % [m] - radius of the water column + steel mantle
radius_2 = radius_1 + 0.01;
...
storage = StratifiedHeatStorage([35,90], N, delta_z, radius_1, radius_2, radius_3, delta_t);    % spread between [cold, hot] in [C]
simulation_handler =SimulationHandler(2.02*24*3600, delta_t, storage);                             % overall time in seconds
